        ...
        {actions.map((action: Action, i: any) => (
          ...
          >
            ...
            {action.is_error ? (
              ...
              <Badge variant="default" className="flex gap-2 bg-main-green">
                <span>Done</span>
                <MdDone />
              </Badge>
              ...
              <div className="text-gray-400 text-md flex items-center gap-4">
                ...
                <Select
                  ...
                  value={selcted}
                >
                  <SelectTrigger className="w-32 outline-none focus:outline-none focus:ring-0 text-center bg-drop-zone text-md font-medium">
            ...
            {action.is_converted ? (
              ...
              <span
                ...
                className="cursor-pointer hover:bg-drop-zone rounded-full h-10 w-10 flex items-center justify-center text-2xl text-gray-400"
              >
                <MdClose />
              </span>
            )}
  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
          {...getRootProps()}
          className=" bg-drop-zone h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-2 border-dashed cursor-pointer flex items-center justify-center"
        >
          <input {...getInputProps()} />
